...
public class Net25detection {

    private static final Logger log = LoggerFactory.getLogger(Net25detection.class);
	...
	public static void main(String[] args) {
        ...
        File parentDir = new File("/home/ambra/Deep Learning/LFW/training/detection-25");
