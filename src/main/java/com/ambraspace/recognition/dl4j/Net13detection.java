...
public class Net13detection {

    private static final Logger log = LoggerFactory.getLogger(Net13detection.class);
	...
	public static void main(String[] args) {
        ...
        File parentDir = new File("/home/ambra/Deep Learning/LFW/training/detection-13");
