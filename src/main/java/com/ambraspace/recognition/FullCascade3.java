...
public class FullCascade3 {
	
	private static long numOfFrames = 0;
	
	private static final Logger log = LoggerFactory.getLogger(FullCascade3.class);
...
//		File srcFolder = new File("/home/ambra/Deep Learning/FDDB/originalPics/");
		...
		FullCascade3 fc1 = new FullCascade3(
				net13detection,
				net13calibration,
				net25detection,
				net25calibration,
...
//		File srcFolder = new File("/home/ambra/Deep Learning/ImageNet/class1/");
		File srcFolder = new File("/home/ambra/ttttt/");
		File dstFolder = new File("/home/ambra/Deep Learning/ImageNet/detected/");
